...
function completarSelectTipoGestion(element,index,arr){
    const idTipoGestion = document.querySelector('#sel_id_tipo_gestion').value;

    if(idTipoGestion===element.id_tipo_gestion.toString()){
    arr[index] = document.querySelector('#sel_id_tipo_gestion').innerHTML += 
    `<option value='${element.id_tipo_gestion}' selected>${element.nombre_tipo_gestion}</option>`
    }else{
        arr[index] = document.querySelector('#sel_id_tipo_gestion').innerHTML += 
 ...
 function completarSelectResultado(element,index,arr){
    const idResultado = document.querySelector('#sel_id_resultado').value;

    if(idResultado===element.id_resultado.toString()){
    arr[index] = document.querySelector('#sel_id_resultado').innerHTML += 
    `<option value='${element.id_resultado}' selected>${element.nombre_resultado}</option>`
    }else{
        arr[index] = document.querySelector('#sel_id_resultado').innerHTML += 
 ...
 function completarSelectCliente(element,index,arr){
    const idCliente = document.querySelector('#sel_id_cliente').value;

    if(idCliente===element.id_cliente.toString()){
    arr[index] = document.querySelector('#sel_id_cliente').innerHTML += 
    `<option value='${element.id_cliente}' selected>${element.apellidos} ${element.nombres}</option>`
    }else{
        arr[index] = document.querySelector('#sel_id_cliente').innerHTML += 
 ...
 function completarSelectUsuario(element,index,arr){
    const idUsuario = document.querySelector('#sel_id_usuario').value;

    if(idUsuario===element.id_usuario.toString()){
    arr[index] = document.querySelector('#sel_id_usuario').innerHTML += 
    `<option value='${element.id_usuario}' selected>${element.apellidos} ${element.nombres}</option>`
    }else{
        arr[index] = document.querySelector('#sel_id_usuario').innerHTML += 
 ...
 function obtenerParametroGestionActualizar(){
...
function completarFormularioActualizar(element,index,arr){
    ...
    document.getElementById("sel_id_usuario").value = idUsuario;
    document.getElementById("sel_id_cliente").value = idCliente;
    document.getElementById("sel_id_tipo_gestion").value = idTipoGestion;
    document.getElementById("sel_id_resultado").value = idResultado;
    document.getElementById("txt_comentarios").value = comentarios;

}

function actualizarGestion(){
    var usuario = document.getElementById("sel_id_usuario").value;
    var cliente = document.getElementById("sel_id_cliente").value;
    var tipoGestion = document.getElementById("sel_id_tipo_gestion").value;
    var resultado = document.getElementById("sel_id_resultado").value;
